...
return {
	...
	setup = function(config)
		...
		-- vim.api.nvim_create_user_command("SnipeLspSymbolsVSplit", open_symbols_menu_for_split("vsplit"), { nargs = 0 })
	end,
}
